...
def run_all_metrics(logs_df):
    ...
    results['error_rate_success_rate'] = calculate_error_rate_success_rate(
        logs_df
    )
    results['average_time_spent_on_site'] = (
        calculate_average_time_spent_on_site(
            logs_df
        )
    )
    results['average_time_spent_per_page'] = (
        calculate_average_time_spent_per_page(
            logs_df
        )
    )
    ...
    results['downloadable_resources_hits_ratio'] = (
    ...
    print("User metrics:")
    results['average_pages_viewed'] = (
        calculate_average_pages_viewed_per_session(
            logs_df
        )
    )
    # results['average_pages_viewed_categorization'] = (
    ...
    # results['average_time_spent_on_site_categorization'] = (
    #     calculate_weighted_average_time_spent_on_site(logs_df)
    # )
    # results['average_time_spent_per_page_categorization'] = (
